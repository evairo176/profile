...
const Hero = () => {
  ...
  return (
    <motion.section
      ...
      className="relative flex min-h-screen items-center justify-center py-24 text-white/80 md:py-0"
    >
      ...
      <div className="max-auto z-10 flex max-w-6xl flex-col items-center justify-between gap-12 md:flex-row">
        ...
        >
          <p className="mb-2 rounded-xl border border-purple-300/80 bg-purple-700/40 px-3 py-1 text-sm">
            Available for new projects
          </p>
          <p className="text-4xl font-bold md:text-5xl">Hi, I am</p>
          <p className="bg-gradient-to-r from-white to-purple-400 bg-clip-text text-4xl font-bold text-transparent md:text-6xl">
            Dicki Prasetya
          </p>
        ...
        >
          ...
          />
          <div className="relative z-10 rounded-full border border-gray-200/30 bg-gradient-to-b to-black mask-radial-from-gray-900 shadow-xl">
            <Image
              src={profilepic}
              alt="profile"
              width={300}
          ...
          <motion.div
            ...
            className="absolute -right-2 -bottom-2 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 px-3 py-1 text-sm font-medium"
          >
            Developer
          </motion.div>
        </motion.div>
