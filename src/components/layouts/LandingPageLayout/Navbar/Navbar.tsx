...
const Navbar = () => {
  ...
  return (
    <div className="z-50">
      {/* Desktop navbar */}
      <div className="border-border bg-card/40 supports-[backdrop-filter]:bg-card/30 mx-auto mt-12 hidden max-w-[400px] items-center justify-center rounded-3xl border p-2 backdrop-blur md:flex">
        <div className="mr-3">
          <ModeToggle />
        </div>
